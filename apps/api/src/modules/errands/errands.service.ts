...
import { distanceKm, RT_EVENTS, rtRooms, serviceTypeConfigSchema } from '@sprintgo/shared';
import type {
  AddressSnapshot,
...
export class ErrandsService {
  ...
  private priceErrand(
    st: ServiceType,
    zoneId: string,
    opts: { pickup?: Point | null; dropoff?: Point | null; zoneCentroid?: Point | null },
    ...
    return { fee: Math.max(raw, minFee), distanceKm: dist };
  }
